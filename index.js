...
const lexerModule = require('./parser/MyLexer');
const parserModule = require('./parser/MyGrammar');

const autosuggester = autosuggest.autosuggester(lexerModule.MyLexer, parserModule.MyGrammar, 'LOWER');
