ace.define(
  ...
  function(require, exports, module) {
    ...
    var tokenTypeMapping = antlr4_require('./token-type-mapping');
    ...
    var MyLexer = antlr4_require('./parser/MyLexer').MyLexer;
    ...
    (function() {
      ...
      this.getTokenizer = function() {
        if (!this.$tokenizer) {
          this.$tokenizer = new Antlr4Tokenizer(MyLexer, tokenTypeToNameMap);
        }
